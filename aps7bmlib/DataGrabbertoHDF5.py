...
Jul 20, 2018: DD removed some APS-specific file paths and changed the way the
           HDF5 filename and path are autogenerated.
"""
...
def fconvert_and_average_file(dg_filename,hdf_filename=None,path='',group_keys = ("X","Y"), convert_volts=True,average=True):
    ...
    if not hdf_filename:
        hdf_filename = os.path.splitext(dg_filename)[0]+'.hdf5'
